...
{{--									<td>£{{$product->price.' * '.$product->quantity.' = '. $product->price * $product->quantity}}</td>--}}
                                    ...
                                    @if(@$product->charges_check == 1)
                                        ...
                                        <tr>
                                        <td  style="background-color: {{@$product->color}}" > <b>{{"Courier :".$product->courier_detail?$product->courier_detail->couriers->name:''." | £".$product->courier_detail?$product->courier_detail->couriers->charges:0}}</b></td>
