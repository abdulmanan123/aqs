...
<!--                    @if(showDiscount($product))
                    ...
                    @endif
                        <div class="product-name">
                            <a href="{{ url('products/'.$slug) }}" title="{{ $product->name }}">{{ str_limit($product->name,25) }}<br />{{ $product->sku }}</a>
                        </div>
                        <div class="price">
    ...
    <div class="sort-box list_section">
        ...
        <div class="product-box style3">
            <div class="imagebox style1 v3">
                ...
                @endif
                    <div class="product-name">
                        <a href="{{ url('products/'.Hashids::encode($product->id)) }}" title="{{ $product->name }}">{{ str_limit($product->name,25) }}<br />{{ $product->sku }}</a>
                    </div>
                    <div class="status">
                        Availablity:
